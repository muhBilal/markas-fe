        ...
        <Container>
            <div className="py-32 ">
                <div className="md:px-32 text-center flex flex-col gap-8 items-center">
                    <h2 className={`text-[#D90027] font-semibold ${lexend_peta.className} text-xl md:text-2xl  uppercase`}>Kolaborasi</h2>
                    <h2 className="font-bold text-2xl md:text-4xl uppercase">Pusat Kolaboarsi Ekosistem Digital</h2>
